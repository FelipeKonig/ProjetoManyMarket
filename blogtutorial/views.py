...
def post_draft_list(request):
    ...
    return render(request, 'blogtutorial/post_draft_list.html', {'posts': posts})
...
def add_comment_to_post(request, pk):
    ...
    if request.method == "POST":
        ...
        form = CommentForm()
    return render(request, 'blogtutorial/add_comment_to_post.html', {'form': form})
